var _=i=>{throw TypeError(i)};var R=(i,e,t)=>e.has(i)||_("Cannot "+t);var c=(i,e,t)=>(R(i,e,"read from private field"),t?t.call(i):e.get(i)),w=(i,e,t)=>e.has(i)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(i):e.set(i,t),y=(i,e,t,a)=>(R(i,e,"write to private field"),a?a.call(i,t):e.set(i,t),t),M=(i,e,t)=>(R(i,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const se="modulepreload",re=function(i){return"/submission/"+i},j={},oe=function(e,t,a){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),n=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=re(l),l in j)return;j[l]=!0;const d=l.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${g}`))return;const v=document.createElement("link");if(v.rel=d?"stylesheet":se,d||(v.as="script"),v.crossOrigin="",v.href=l,n&&v.setAttribute("nonce",n),document.head.appendChild(v),d)return new Promise((H,ie)=>{v.addEventListener("load",H),v.addEventListener("error",()=>ie(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return s.then(o=>{for(const n of o||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})};class q{constructor(e){this.viewModel=e,this.view=null}setView(e){this.view=e}async fetchData(){}async handleUserAction(e,t){}}class P{constructor(){this.data=null,this.loading=!1,this.error=null}setLoading(e){this.loading=e}setError(e){this.error=e}clearError(){this.error=null}setData(e){this.data=e}}const D={BASE_URL:"https://story-api.dicoding.dev/v1"},C={REGISTER:`${D.BASE_URL}/register`,LOGIN:`${D.BASE_URL}/login`,GET_STORIES:`${D.BASE_URL}/stories`,ADD_STORY:`${D.BASE_URL}/stories`};async function ne(i,e,t){const a=await fetch(C.REGISTER,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,email:i,password:t})});if(!a.ok){const s=await a.json();throw new Error(s.message||"Registration failed")}return await a.json()}async function le(i,e){const t=await fetch(C.LOGIN,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,password:e})});if(!t.ok){const a=await t.json();throw new Error(a.message||"Login failed")}return await t.json()}async function ce(i=1,e=20,t=void 0){let a=`${C.GET_STORIES}?page=${i}&size=${e}`;t!==void 0&&(a+=`&location=${t}`);const s=localStorage.getItem("token"),r={"Content-Type":"application/json"};s&&(r.Authorization=`Bearer ${s}`);const o=await fetch(a,{headers:r});if(!o.ok)throw new Error("Failed to fetch stories");return await o.json()}async function de(i){const e=localStorage.getItem("token"),t={};e&&(t.Authorization=`Bearer ${e}`);const a=await fetch(C.ADD_STORY,{method:"POST",headers:t,body:i});if(!a.ok){const s=await a.json();throw new Error(s.message||"Failed to add story")}return await a.json()}function V(i){localStorage.setItem("token",i)}function ue(){return localStorage.getItem("token")}function he(){localStorage.removeItem("token")}function b(){return!!ue()}function N(i){localStorage.setItem("user",JSON.stringify(i))}function pe(){localStorage.removeItem("user")}function me(){he(),pe()}const fe="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk",W="push-subscription",z="push-enabled";function ve(i){const e="=".repeat((4-i.length%4)%4),t=(i+e).replace(/-/g,"+").replace(/_/g,"/"),a=window.atob(t),s=new Uint8Array(a.length);for(let r=0;r<a.length;++r)s[r]=a.charCodeAt(r);return s}function G(){return localStorage.getItem(z)==="true"}function x(i){localStorage.setItem(z,i?"true":"false")}function F(i){localStorage.setItem(W,JSON.stringify(i))}function ge(){localStorage.removeItem(W)}async function K(){if(!("serviceWorker"in navigator))throw new Error("Service Worker not supported");if(await Notification.requestPermission()!=="granted")throw new Error("Notification permission not granted");const e=await navigator.serviceWorker.ready,t=await e.pushManager.getSubscription();if(t)return F(t),x(!0),t;const a=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:ve(fe)});return F(a),x(!0),a}async function we(){if(!("serviceWorker"in navigator))return;const e=await(await navigator.serviceWorker.ready).pushManager.getSubscription();e&&await e.unsubscribe(),ge(),x(!1)}async function ye(){if(!G())return null;const t=await(await navigator.serviceWorker.ready).pushManager.getSubscription();return t?(F(t),t):await K()}const be="storyapp-db",Se=2,u={STORIES:"stories",FAVORITES:"favorites",QUEUE:"sync-queue"};function S(){return new Promise((i,e)=>{const t=indexedDB.open(be,Se);t.onupgradeneeded=()=>{const a=t.result;if(!a.objectStoreNames.contains(u.STORIES)){const s=a.createObjectStore(u.STORIES,{keyPath:"id"});s.createIndex("createdAt","createdAt",{unique:!1}),s.createIndex("lat","lat",{unique:!1}),s.createIndex("lon","lon",{unique:!1}),s.createIndex("name","name",{unique:!1})}a.objectStoreNames.contains(u.QUEUE)||a.createObjectStore(u.QUEUE,{keyPath:"queueId",autoIncrement:!0}),a.objectStoreNames.contains(u.FAVORITES)||a.createObjectStore(u.FAVORITES,{keyPath:"id"})},t.onsuccess=()=>i(t.result),t.onerror=()=>e(t.error)})}function k(i,e,t){return i.transaction(e,t).objectStore(e)}function E(i){return new Promise((e,t)=>{i.onsuccess=()=>e(i.result),i.onerror=()=>t(i.error)})}function ke(i){return`${i.name||""} ${i.description||""}`.toLowerCase()}async function O(i){const e=await S(),t=k(e,u.STORIES,"readwrite");return await E(t.put(i)),e.close(),i}async function J(){const i=await S(),t=k(i,u.STORIES,"readonly").getAll(),a=await E(t);return i.close(),a||[]}async function Y(i){const e=await S(),t=k(e,u.STORIES,"readwrite");await E(t.delete(i)),e.close()}async function Q(i){const e=await S(),t=k(e,u.FAVORITES,"readwrite");return await E(t.put(i)),e.close(),i}async function U(){const i=await S(),t=k(i,u.FAVORITES,"readonly").getAll(),a=await E(t);return i.close(),a||[]}async function B(i){const e=await S(),t=k(e,u.FAVORITES,"readwrite");await E(t.delete(i)),e.close()}async function Z(i){const e=await S(),t=k(e,u.QUEUE,"readwrite"),a=await E(t.add(i));return e.close(),a}function X(i,{query:e="",location:t=null,sort:a="latest"}={}){const s=(e||"").trim().toLowerCase();let r=i;return t&&(r=r.filter(o=>o.lat===t.lat&&o.lon===t.lon)),s&&(r=r.filter(o=>ke(o).includes(s))),a==="name"?r=[...r].sort((o,n)=>(o.name||"").localeCompare(n.name||"")):a==="oldest"?r=[...r].sort((o,n)=>new Date(o.createdAt||0)-new Date(n.createdAt||0)):r=[...r].sort((o,n)=>new Date(n.createdAt||0)-new Date(o.createdAt||0)),r}const Le=Object.freeze(Object.defineProperty({__proto__:null,filterStories:X,idbDeleteFavoriteStory:B,idbDeleteStory:Y,idbGetAllFavoriteStories:U,idbGetAllStories:J,idbPutFavoriteStory:Q,idbPutStory:O,idbQueueEnqueue:Z},Symbol.toStringTag,{value:"Module"}));class Ee extends P{constructor(){super(),this.stories=[],this.filteredStories=[],this.currentLocation=null,this.offlineStoriesLoaded=!1}setStories(e){this.stories=e,this.filteredStories=e}filterByLocation(e){this.currentLocation=e,e===null?this.filteredStories=this.stories:this.filteredStories=this.stories.filter(t=>t.lon===e.lon&&t.lat===e.lat)}}class Me extends q{async loadStories(){try{const e=await J();e&&e.length>0&&(this.viewModel.setStories(e),this.viewModel.offlineStoriesLoaded=!0)}catch{}try{this.viewModel.setLoading(!0),this.viewModel.clearError();const a=((await ce()).listStory||[]).map(s=>({...s,id:s.id||`${s.lat}-${s.lon}-${s.createdAt||""}`}));this.viewModel.setStories(a);try{for(const s of a)await oe(async()=>{const{idbPutStory:r}=await Promise.resolve().then(()=>Le);return{idbPutStory:r}},void 0).then(({idbPutStory:r})=>r(s))}catch{}return!0}catch(e){return this.viewModel.offlineStoriesLoaded?!0:(this.viewModel.setError(e.message),!1)}finally{this.viewModel.setLoading(!1)}}filterStories(e){this.viewModel.filterByLocation(e)}}class Ae{constructor(){this.viewModel=new Ee,this.presenter=new Me(this.viewModel),this.presenter.setView(this),this.map=null,this.markers={},this.favoriteIds=new Set,this.tileLayerControl=null}async render(){return`
    ...
    `}async afterRender(){if(!b())return;this.setupPushToggle(),await this.presenter.loadStories(),await this.loadFavoriteIds(),this.initializeMap(),this.renderStories();const e=document.querySelector("#filter-all");e&&e.addEventListener("click",()=>{this.presenter.filterStories(null),document.querySelectorAll(".filter-btn").forEach(t=>{t.classList.remove("active"),t.setAttribute("aria-pressed","false")}),e.classList.add("active"),e.setAttribute("aria-pressed","true"),this.updateMapMarkers(),this.renderStories()}),this.setupStoriesInteractivity()}initializeMap(){this.map&&this.map.remove();const e=document.querySelector("#map");if(!e)return;this.map=L.map(e).setView([-6.2088,106.8456],13);const t=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap contributors",maxZoom:19}),a=L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:"Tiles © Esri",maxZoom:19});t.addTo(this.map),L.control.layers({OpenStreetMap:t,Satellite:a},{}).addTo(this.map),this.updateMapMarkers()}updateMapMarkers(){if(this.map&&(Object.values(this.markers).forEach(e=>{this.map.removeLayer(e)}),this.markers={},this.viewModel.filteredStories.forEach(e=>{if(e.lat&&e.lon){const t=L.marker([e.lat,e.lon]).addTo(this.map),a=`
      ...
      `}).join("");e.innerHTML=a,document.querySelectorAll(".story-card").forEach(s=>{s.addEventListener("click",()=>{const r=parseFloat(s.dataset.lat),o=parseFloat(s.dataset.lon);document.querySelectorAll(".story-card.active").forEach(l=>{l.classList.remove("active")}),s.classList.add("active");const n=`${r}-${o}`;this.markers[n]&&(this.markers[n].openPopup(),this.map.setView([r,o],16))})})}setupPushToggle(){const e=document.querySelector("#push-toggle");e&&(e.checked=G(),e.addEventListener("change",async()=>{if(e.checked)try{await K()}catch(t){e.checked=!1,x(!1),console.warn(t)}else await we()}))}setupStoriesInteractivity(){const e=document.querySelector("#stories-search"),t=document.querySelector("#stories-sort"),a=()=>{const s=e?e.value:"",r=t?t.value:"latest",o=X(this.viewModel.stories,{query:s,location:this.viewModel.currentLocation,sort:r});this.viewModel.filteredStories=o,this.updateMapMarkers(),this.renderStories()};e&&e.addEventListener("input",a),t&&t.addEventListener("change",a),document.querySelectorAll(".story-card .delete-story-btn").forEach(s=>{s.addEventListener("click",async r=>{var l;r.preventDefault(),r.stopPropagation();const o=s.closest(".story-card"),n=(l=o==null?void 0:o.dataset)==null?void 0:l.id;n&&(await Y(n),this.viewModel.stories=this.viewModel.stories.filter(d=>String(d.id)!==String(n)),this.viewModel.filteredStories=this.viewModel.stories,this.updateMapMarkers(),this.renderStories())})}),document.querySelectorAll(".story-card .favorite-story-btn").forEach(s=>{s.addEventListener("click",async r=>{var l;r.preventDefault(),r.stopPropagation();const o=s.closest(".story-card"),n=(l=o==null?void 0:o.dataset)==null?void 0:l.id;n&&await this.toggleFavoriteStory(n)})})}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}class Ie{async render(){return`
    ...
    `}async afterRender(){}}class Te extends P{}class qe extends q{async handleLogin(e,t){try{this.viewModel.setLoading(!0),this.viewModel.clearError();const a=await le(e,t);return V(a.loginResult.token),N({userId:a.loginResult.userId,name:a.loginResult.name,email:a.loginResult.email}),this.viewModel.setData(a.loginResult),!0}catch(a){return this.viewModel.setError(a.message),!1}finally{this.viewModel.setLoading(!1)}}}class Pe{constructor(){this.viewModel=new Te,this.presenter=new qe(this.viewModel),this.presenter.setView(this)}async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#login-form"),t=document.querySelector("#login-submit"),a=document.querySelector("#error-message");e.addEventListener("submit",async s=>{s.preventDefault();const r=e.querySelector('[name="email"]').value.trim(),o=e.querySelector('[name="password"]').value;if(!r||!o){a.textContent="Email dan password harus diisi";return}t.disabled=!0,t.setAttribute("aria-busy","true"),a.textContent="",await this.presenter.handleLogin(r,o)?window.location.hash="#/":(a.textContent=this.viewModel.error,t.disabled=!1,t.setAttribute("aria-busy","false"))})}}class De extends P{}class xe extends q{async handleRegister(e,t,a){try{this.viewModel.setLoading(!0),this.viewModel.clearError();const s=await ne(e,t,a);return V(s.loginResult.token),N({userId:s.loginResult.userId,name:s.loginResult.name,email:s.loginResult.email}),this.viewModel.setData(s.loginResult),!0}catch(s){return this.viewModel.setError(s.message),!1}finally{this.viewModel.setLoading(!1)}}}class Ce{constructor(){this.viewModel=new De,this.presenter=new xe(this.viewModel),this.presenter.setView(this)}async render(){return`
      <main class="auth-main">
        <section class="auth-container">
          <div class="auth-card">
            <h1>Daftar Akun</h1>
    ...
    `}async afterRender(){b()&&(await this.presenter.loadFavorites(),this.renderFavorites(),this.setupFavoriteActions())}renderFavorites(){const e=document.querySelector("#favorites-list");if(!e)return;if(!this.viewModel.favorites||this.viewModel.favorites.length===0){e.innerHTML='<p class="no-data">Belum ada cerita favorit.</p>';return}const t=this.viewModel.favorites.map(a=>`
        ...
        `).join("");e.innerHTML=t}setupFavoriteActions(){document.querySelectorAll(".remove-favorite-btn").forEach(e=>{e.addEventListener("click",async t=>{var r;t.preventDefault();const a=e.closest(".favorite-card"),s=(r=a==null?void 0:a.dataset)==null?void 0:r.id;s&&(await this.presenter.deleteFavorite(s),this.renderFavorites())})})}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}const _e={"/":new Ae,"/about":new Ie,"/login":new Pe,"/register":new Ce,"/add-story":new Oe,"/story":new $e,"/favorites":new He};function je(i){const e=i.split("/");return{resource:e[1]||null,id:e[2]||null}}function Ve(i){let e="";return i.resource&&(e=e.concat(`/${i.resource}`)),i.id&&(e=e.concat("/:id")),e||"/"}function Ne(){return location.hash.replace("#","")||"/"}function We(){const i=Ne(),e=je(i);return Ve(e)}var p,m,h,A,I,T,f,ee,te,ae,$;class ze{constructor({navigationDrawer:e,drawerButton:t,content:a}){w(this,f);w(this,p,null);w(this,m,null);w(this,h,null);w(this,A,null);w(this,I,null);w(this,T,null);y(this,p,a),y(this,m,t),y(this,h,e),y(this,A,document.querySelector("#close-drawer-btn")),y(this,I,document.querySelector("#logout-btn")),y(this,T,document.querySelector("#logout-item")),M(this,f,ee).call(this),M(this,f,te).call(this),M(this,f,ae).call(this),M(this,f,$).call(this)}async renderPage(){const e=We(),t=_e[e];if(!t){c(this,p).innerHTML='<section class="container"><h1>Halaman tidak ditemukan</h1></section>';return}document.startViewTransition?document.startViewTransition(async()=>{c(this,p).innerHTML=await t.render(),await t.afterRender()}):(c(this,p).classList.add("fade-out"),await new Promise(a=>setTimeout(a,200)),c(this,p).innerHTML=await t.render(),c(this,p).classList.remove("fade-out"),c(this,p).classList.add("fade-in"),await t.afterRender(),setTimeout(()=>{c(this,p).classList.remove("fade-in")},300)),M(this,f,$).call(this)}}p=new WeakMap,m=new WeakMap,h=new WeakMap,A=new WeakMap,I=new WeakMap,T=new WeakMap,f=new WeakSet,ee=function(){c(this,m).addEventListener("click",()=>{c(this,h).classList.toggle("open");const e=c(this,h).classList.contains("open");c(this,m).setAttribute("aria-expanded",e)}),c(this,A)&&c(this,A).addEventListener("click",()=>{c(this,h).classList.remove("open"),c(this,m).setAttribute("aria-expanded","false")}),document.body.addEventListener("click",e=>{!c(this,h).contains(e.target)&&!c(this,m).contains(e.target)&&(c(this,h).classList.remove("open"),c(this,m).setAttribute("aria-expanded","false"))}),c(this,h).querySelectorAll("a, button").forEach(e=>{e.addEventListener("click",()=>{c(this,h).classList.remove("open"),c(this,m).setAttribute("aria-expanded","false")})}),document.addEventListener("keydown",e=>{e.key==="Escape"&&(c(this,h).classList.remove("open"),c(this,m).setAttribute("aria-expanded","false"))})},te=function(){c(this,I)&&c(this,I).addEventListener("click",()=>{me(),window.location.hash="#/login"})},ae=function(){const e=document.querySelector("#main-content"),t=document.querySelector(".skip-link");t&&e&&t.addEventListener("click",function(a){a.preventDefault(),t.blur(),e.focus(),e.scrollIntoView()})},$=function(){const e=b();c(this,T)&&(c(this,T).style.display=e?"block":"none")};async function Ge(){if("serviceWorker"in navigator)try{const i=await navigator.serviceWorker.register("/submission/sw.js");await ye(),navigator.serviceWorker.addEventListener("message",e=>{!e||!e.data||e.data.type==="NAVIGATE"&&e.data.url&&(window.location.hash=e.data.url.replace(/^.*#/,""),e.data.url.startsWith("/"))}),console.log("SW registered",i)}catch(i){console.warn("SW registration failed",i)}}document.addEventListener("DOMContentLoaded",async()=>{await Ge();const i=new ze({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await i.renderPage(),window.addEventListener("hashchange",async()=>{await i.renderPage()})});
